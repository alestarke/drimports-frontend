                  ...
                  <tr key={product.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-500 uppercase">
                            {product.brand?.name || 'Sem Marca'} • {product.category?.name || 'Sem Categoria'}
                          </p>
                        </div>
                      </div>
                    </td>
                    ...
                    <td className="px-6 py-4">
                      <span className={`px-3 py-1 rounded-full text-xs font-bold ${
                        product.stock_quantity > 5 ? 'bg-green-100 text-green-700' : 'bg-red-100 text-red-700'
                      }`}>
        ...
        <form onSubmit={handleSave} className="space-y-4">
          ...
          <div className="flex justify-end gap-3 pt-6 border-t border-gray-100 mt-4">
            ...
            <button 
              ...
              className="bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded-lg flex items-center gap-2 font-medium disabled:opacity-70 transition-all active:scale-95 shadow-md shadow-blue-600/20"
            >
