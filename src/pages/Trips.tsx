...
import { Plane, Plus, Search, Trash2, Loader2, Edit, ChevronLeft, ChevronRight } from 'lucide-react';
            ...
            <table className="w-full text-left border-collapse text-sm">
              ...
              <tbody className="divide-y divide-slate-100">
                {paginatedTrips.map((trip) => (
                  <tr key={trip.id} className="hover:bg-slate-50/60 transition-colors h-[62px]">
