...
import { Plus, Search, Edit, Trash2, User, Phone, Mail, Loader2, MapPin, ChevronLeft, ChevronRight } from 'lucide-react';
            ...
            <table className="w-full text-left border-collapse text-sm">
              ...
              <tbody className="divide-y divide-slate-100">
                {paginatedClients.map((client) => (
                  <tr key={client.id} className="hover:bg-slate-50/60 transition-colors h-[62px]">
